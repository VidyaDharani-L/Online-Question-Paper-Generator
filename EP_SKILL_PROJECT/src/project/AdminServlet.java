...
public class AdminServlet extends HttpServlet {
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String ques=request.getParameter("ques1");
		...
		PreparedStatement pstmt=con.prepareStatement("insert into addque values(?,?,?,?,?,?)");
		...
		if(i>0) 
		{
			...
			response.sendRedirect("merge.html");
			...
			request.getRequestDispatcher("merge.html").include(request,response);
